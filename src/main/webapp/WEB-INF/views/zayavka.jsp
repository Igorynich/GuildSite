...
<span><s:message code="zayavka.date"/><c:out value="${zayavka.date}"/></span>
<br>
<br>
...
<div class="mainform">
    ...
    <br>
    <s:message code="vsezayavki.class"/><c:out value="${zayavka.wowClass.wowClass}"/><br>
    <s:message code="vsezayavki.spec"/><c:out value="${zayavka.wowClass.wowSpec}"/><br>
